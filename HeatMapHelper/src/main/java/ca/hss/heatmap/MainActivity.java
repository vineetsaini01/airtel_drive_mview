...
public class MainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
   ...
   //     map.setMarkerCallback(new HeatMapMarkerCallback.CircleHeatMapMarker(0xff9400D3));
        map.setMarkerCallback(new HeatMapMarkerCallback.CircleHeatMapMarker(Color.DKGRAY));
        map.setRadius(80);
        ...
        for (int i = 0; i < 21; i++) {
           ...
           // Log.i(TAG,"Stop "+stop);
            ...
            Log.i(TAG,"Stop "+stop+" , color "+color);
    ...
    private void drawNewMap() {
        ...
        for (int i = 0; i < 20; i++) {
           /*HeatMap.DataPoint point = new HeatMap.DataPoint(i,
               i,  i);
            map.addData(point);*/
           /*HeatMap.DataPoint point = new HeatMap.DataPoint(clamp(rand.nextFloat(), 0.0f, 1.0f),
                    clamp(rand.nextFloat(), 0.0f, 1.0f), clamp(rand.nextDouble(), 0.0, 100.0), getColors(points.get(i).getColor()));
            map.addData(point);*/
