...
/**
 * Created by Sharad Gupta on 9/21/2016.
 */
...
*/
    ...
    private static JSONObject getGSMNetworkParams() throws  JSONException {
...
return sec_strength;
    ...
    public static String API_sendWebTest(String src) {
       ...
       new Async_APIToSendWebTest(src).execute();
    ...
    public static String API_sendNeighboringCellsInfo() {
        System.out.println("SendNeighboringCellsInfo ");
        String res = "";
        try {
        ...
        {
            e.printStackTrace();
            System.out.println("exception in SendNeighboringCellsInfo is"+e.toString());
        }
        return res;
    }
    ...
    public static String API_sendPeriodicData(CapturedPhoneState obj) {
        String res = "";
     new Async_APIToSendPeriodicData().execute(obj);
    ...
    static class Async_APIToSendPeriodicData extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... params) {
            ...
            try {
                ...
                if (obj.roaming)
                    jsonObject.put("roaming", "1");
                else
                    jsonObject.put("roaming", "0");
...
*/
    ...
    static class Async_APIToSendVideoTest extends AsyncTask<Object, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
         System.out.println("in pre execute of videotest api");
        }
