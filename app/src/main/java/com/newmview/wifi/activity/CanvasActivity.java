...
public class CanvasActivity extends AppCompatActivity implements View.OnClickListener,
        SeekBar.OnSeekBarChangeListener, ScreenShotable, ViewAnimator.ViewAnimatorListener, MyAlertDialog.AlertDialogInterface {
   ...
   //     drawerToggle.syncState();
    ...
    public void addViewToContainer(View view) {
        canvasBinding.leftDrawer.addView(view);
    }
