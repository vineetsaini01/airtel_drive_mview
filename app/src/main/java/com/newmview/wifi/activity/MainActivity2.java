//package com.visionairtel.wifi.activity;
//
...
//import com.services.HtmlDriverService;
//import com.services.YouTubeBackgroundService;
//import com.visionairtel.wifi.BuildConfig;
//import com.visionairtel.wifi.R;
//import com.visionairtel.wifi.TinyDB;
//import com.visionairtel.wifi.adapter.MyExpandableAdapter;
//import com.visionairtel.wifi.application.MviewApplication;
//import com.visionairtel.wifi.bean.Db_Bean;
//import com.visionairtel.wifi.bean.Graphs_Bean;
//import com.visionairtel.wifi.bean.Pinger;
...
//import com.visionairtel.wifi.fragment.Call_msg_fragment;
//import com.visionairtel.wifi.fragment.ChartsFragment;
//import com.visionairtel.wifi.fragment.Dwnld_upload_fragment;
//import com.visionairtel.wifi.fragment.FiveGParametersFragment;
//import com.visionairtel.wifi.fragment.HomeFragment;
//import com.visionairtel.wifi.fragment.MainSettingsFragment;
//import com.visionairtel.wifi.fragment.MoviesFragment;
//import com.visionairtel.wifi.fragment.NotificationsFragment;
//import com.visionairtel.wifi.fragment.PhotosFragment;
//import com.visionairtel.wifi.fragment.SettingsFragment;
//import com.visionairtel.wifi.fragment.SpeedTestFragment;
//import com.visionairtel.wifi.fragment.SpeedTestOptions;
//import com.visionairtel.wifi.fragment.SubscribersListFragment;
//import com.visionairtel.wifi.fragment.TraceroutFragment;
//import com.visionairtel.wifi.fragment.VideoSpeedtest_fragment;
//import com.visionairtel.wifi.fragment.Webtest_fragment;
//import com.visionairtel.wifi.helper.CommonUtil;
//import com.visionairtel.wifi.helper.DialogClass;
//import com.visionairtel.wifi.helper.Interfaces;
//import com.visionairtel.wifi.helper.WebViewHelper;
//import com.visionairtel.wifi.interfaces.AsynctaskListener;
//import com.visionairtel.wifi.listenService;
//import com.visionairtel.wifi.mView_HealthStatus;
//import com.visionairtel.wifi.other.CommonAlertDialog;
//import com.visionairtel.wifi.other.Config;
//import com.visionairtel.wifi.other.Constants;
//import com.visionairtel.wifi.other.DialogManager;
//import com.visionairtel.wifi.other.Utils;
//import com.visionairtel.wifi.viewmodel.DialogViewModel;
//
...
//
//import static com.visionairtel.wifi.application.MviewApplication.batteryList;
//import static com.visionairtel.wifi.application.MviewApplication.timeStamp;
//
//public class MainActivity2 extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener, AsynctaskListener, MyAlertDialog.AlertDialogInterface {
...
//    private ArrayList<Db_Bean> dashboardsList=new ArrayList<>();
//    //  SWAPNIL bansal 11/07/2022 for pview dashboards  part
//    private ArrayList<ArrayList<Graphs_Bean>> graphsList = new ArrayList<ArrayList<Graphs_Bean>>();
//    private String dbTitle;
//    private ProgressDialog progressDialog;
//    private String str;
//    private double roundoff=0;
//    private String finalspeed;
//    private float uploadfiletime1;
//
//    @Override
//    public void finish() {
//        super.finish();
//        MainActivity2.SEND_API_REQUEST=false;
//        clearvalues();
//    }
...
//    private Call_msg_fragment callmsgfragment;
...
//        editor =getSharedPreferences(MainActivity2.MY_PREFS_NAME, MainActivity2.context.MODE_PRIVATE).edit();
//        editor_n=getSharedPreferences(Constants.service_toggle, MainActivity2.context.MODE_PRIVATE).edit();
//        clearvalues();
//        init();
//        initializeDialogVM();
//        try {
...
//
////startListenService();
//        TinyDB db = new TinyDB(MainActivity2.this);
...
//        },issue);
//    }
//    private void getGraphsList() {
//
//        Log.d(TAG,"getGraphsList(..");
//        Log.d(TAG,"Constants.mappgraphlist"+Constants.mappgraphlist);
//        if (Constants.mappgraphlist != null && Constants.mappgraphlist.size() > 0) {
//            Log.d(TAG,"Constants.mappgraphlist"+Constants.mappgraphlist);
//            for (int j = 0; j < Constants.mappgraphlist.size(); j++) {
//                ArrayList<Graphs_Bean> localgraphsList = new ArrayList<>();
//                for (int i = 0; i < Constants.mappgraphlist.get(j).size(); i++) {
//                    String graphId = Constants.mappgraphlist.get(j).get(i).get("graphId");
//
//                    String graphName = Constants.mappgraphlist.get(j).get(i).get("graphName");
//                    Graphs_Bean graphs_bean = new Graphs_Bean();
//                    graphs_bean.setName(graphName);
//                    graphs_bean.setId(graphId);
//                    localgraphsList.add(graphs_bean);
//                    System.out.println("graph id and name is " + graphId + "   " + graphName);
//                }
//                System.out.println("localgraph list " + localgraphsList.size());
//                graphsList.add(localgraphsList);
//            }
//            System.out.println("local main graphlist " + graphsList.size());
//        }
//
//    }
//    private void getDashboardsList() {
//        dashboardsList = new ArrayList<>();
//        db_handler.open();
...
//            reportList.add("Ping");
//            reportList.add("Traceroute");
//            reportList.add(Config.wifiMapperName);
//            reportList.add("Surveys List");
//            //commented in 2.1.8.2
//            //uncommented in 2.1.9.2
//            // commented for 2.3.0.2
//            if(!BuildConfig.FLAVOR.equalsIgnoreCase("airtelwifi_live")) {
//                reportList.add("SDK App");
//                reportList.add("Dashboard");
//                reportList.add("Settings");
//                reportList.add("5G Parameters");
//                reportList.add("YouTube");
//                reportList.add("Download speed test");
//                reportList.add("Upload speed test");
//
//            }
//            System.out.println("Common util mapgraphlist size "+CommonUtil.mappgraphlist.size());
//
...
//
//            Log.i(TAG,"Map list here "+mappedgraphList);
...
//        //Toast.makeText(getActivity(), "cALLING INIT ", Toast.LENGTH_SHORT).show();
...
//        AsyncTasks_APIgetData asyncTasks_apIgetData=new AsyncTasks_APIgetData(MainActivity.this,this);
...
//        SharedPreferences prefs = getSharedPreferences(MainActivity2.MY_PREFS_NAME, context.MODE_PRIVATE);
//        String restoredText = prefs.getString("userid", null);
//        MainActivity2.SEND_API_REQUEST=false;
//        Intent intent=new Intent(MviewApplication.ctx, com.visionairtel.wifi.application.MviewService.class);
//        stopService(intent);
//
//
//        Log.d(TAG,"onDestroy");
...
//                    editor_n.apply();
//                    Utils.openAutoStartPage(MainActivity2.this);
//                    startAllServices();
//
//                }
//                break;
...
//        String version = "1.0";
//        try {
//            PackageInfo pInfo = MainActivity2.this.getPackageManager().getPackageInfo(getPackageName(), 0);
...
//
//        }
//        txtName.setText(getString(R.string.app_name)+" (" + Constants.getversionnumber(MainActivity2.context) + ")");
//
...
//    }
//    public void openGraphActivity(int mainpos, String dbTitle,int pos) {
//
//        String graphId=null;
//        String graphName=null;
//        this.dbTitle=dbTitle;
//        Log.i(TAG,"Map list here in funcion "+mappedgraphList);
//        if(mappedgraphList.size()==0)
//            mappedgraphList.addAll(CommonUtil.mappgraphlist);
//        if (mappedgraphList != null && mappedgraphList.size() > 0) {
//
//            graphId = mappedgraphList.get(mainpos).get(pos).get("graphId");
//            //String graphId = graphList.get(childPosition).get("graphId");
//            System.out.println("mappedlist " + mappedgraphList.size());
//            graphName = mappedgraphList.get(mainpos).get(pos).get("graphName");
...
//        intent.putExtra("clickedposition", mainpos);
...
//
//        }
//        Intent intent = new Intent(MainActivity2.this, GraphDetailsActivity.class);
//        intent.putExtra("graphId", graphId);
//        intent.putExtra("graphName", graphName);
...
//                        Intent intent6 = new Intent(MainActivity2.this, MainSettings.class);
...
//            Config.onbackpress="back";
//            MainActivity2.RESULT_FLAG=false;
//            MainActivity2.REPORT_FLAG=false;
...
//                        Mview.get_report(getApplicationContext(),"0", "0",Utils.getMyContactNum(MainActivity2.this),"1");
//                        editor_n.putBoolean("service_key", true).apply();
//                       /* editor_n.putBoolean("service_key", true);
//                        editor_n.putBoolean("listen_service",true);
//                        editor_n.apply();
//                        sendToggleOnEvent();
...
//                    }
//                    else {
//                        Mview.get_report(getApplicationContext(),"0",
//                                "0",Utils.getMyContactNum(MainActivity2.this),"2");
...
//        try {
//
//            db_handler = new  DB_handler(MainActivity2.this);
//            db_handler.open();
...
//                    ContextCompat.checkSelfPermission(MainActivity2.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
//                            != PackageManager.PERMISSION_GRANTED ||
//                    ContextCompat.checkSelfPermission(MainActivity2.this,
//                            Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED)
//            {
//                ActivityCompat.requestPermissions(MainActivity2.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION,
//                        Manifest.permission.ACCESS_FINE_LOCATION,
...
//
//
//        final Dialog dialog = new Dialog(MainActivity2.this, R.style.AlertDialogTheme);
//        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
...
//                        Utils.showToast(MainActivity2.this,"You may turn off the autostart service from  app manager of your phone settings.");
//                    }
//                }
//
//
...
//    }
//
//    private void seekReqPermissions(Dialog dialog) {
//
//
//
//
...
//                Config.onbackpress="home";
//                loadFragment(R.string.subscribers_list,new SubscribersListFragment());
...
////        String lon=listenService.gps.getLongitude() + "";
//        //  String lat=listenService.gps.getLatitude() +"";
//        if(issuesList==null)
//        {
...
//                    )
//                    {
//                        requestLocationPermissions(REPORT_ISSUE);
//                    }
//else {
//                        showAlert();
//                    }
//
//                    loadFragment(R.string.nav_home, new HomeFragment(), issuesList.get(0));
//
//                    break;*/
//                case 0:
//                    REPORT_FLAG = true;
//                    // SEND_API_REQUEST=true;
//                    // Utils.showToast(MainActivity.context, Constants.DATA_BW_ISSUE);
//                    //   SpeedTestOptions speedTestOptions = new SpeedTestOptions();
//                    //  MainActivity.RESULT_FLAG=true;
//                    // openVideoTestFragment();
//                    // loadFragment(R.string.speedtest, speedTestOptions, issuesList.get(1));
...
//                    REPORT_FLAG = true;
//                    //  SEND_API_REQUEST=true;
//                    Utils.showToast(MainActivity.context, Constants.CALL_ISSUE);
//                    loadFragment(R.string.call_sms_mms, new Call_msg_fragment(), issuesList.get(2));
//                    Config.onbackpress = "home";
//                    break;*/
//                case 1:
//                    loadFragment(R.string.traceroute, new TraceroutFragment());
//                    Config.onbackpress = "home";
//                 /*   System.out.println("Calling ping methods....");
//                  new DialogClass("Ping").showPingAlert(this);*/
//                    break;
//                case 2:
//                    Bundle bundle=new Bundle();
...
//                   /* loadFragment(R.string.traceroute, new TraceroutFragment());
//                    Config.onbackpress = "home";*/
//                    //  new DialogClass("Trace route").showPingAlert(this);
//                    break;
//                case 3:
//                    //loadFragment(R.string.wifi_coverage_test,new CampaignFragment());
//                    //     startActivity(new Intent(MainActivity.this, CanvasActivity.class));
...
//                // commented for 2.3.0.2
//                case 4:
//                    //"file:///android_asset/iframe_youtube.html"
//                    //  new WebViewHelper(MainActivity.this).loadUrl("file:///android_asset/youtube.html");
//                    //   new WebViewHelper(MainActivity.this).loadUrl("http://factabout.in/mview/sample.html");
//                    //Mview.startvideo();
//                   /* DialogManager.showMyDialog(this,
//                            AlertType.dynamicAlert, alertDialogViewModel, MainActivity.this,
//
//                            "Request submitted for sdk test."
//                            ,
//                            "Sdk Test", null, null,
//                            "OK","");
//
//                   */
//                    Mview.get_report(this,"0","0",
//                            Utils.getMyContactNum(MainActivity.this),"0");
//                    break;
//                case 6:
//                    loadFragment(R.string.main_settings_title, new MainSettingsFragment());
//                    Config.onbackpress = "home";
...
//                    // runWebDriver();
//                    drawer.closeDrawers();
//                    Log.i(TAG,"Start youtube test");
//                /*   Intent youTubeIntent=new Intent(MainActivity.this, YouTubeBackgroundService.class);
//                    startService(youTubeIntent);*/
//                    /*    Utils.showToast(getApplicationContext(),"Youtube test");
//                     */
//                    Mview.get_report(getApplicationContext(),"","","","speed");
//
//                    //  startYouTubeVideo();
//                    //
//
...
//                    drawer.closeDrawers();
//
//                    new BackgroundTasktgetvalues("down").execute();
//
//
//                    break;
//
...
//                    drawer.closeDrawers();
//
//                    new BackgroundTasktgetvalues("up").execute();
//
//
//                    break;
//            }
...
//            InputStream inputStream = getAssets().open("1kb.txt");
...
//        try
//        {
//            showProgressBeforeLoadingData("Starting youtube video test...");
...
//                    Log.i(TAG, Utils.getDateTime() + " Ping response " + response);
//                    if (response != null) {
//                        runOnUiThread(new Runnable() {
//                            @Override
//                            public void run() {
...
//                                dismissProgress();
//                                new WebViewHelper(MviewApplication.ctx, response).
...
//        try {
//            driver = new AndroidDriver("www.google.com");
//            // Let’s open a web page
//            driver.get("http://www.google.com");
//            Log.i(TAG,"Ran the url "+driver.getPageSource());
//
//        } catch (MalformedURLException e) {
//            e.printStackTrace();
//        }
...
//    }
//
//    private void startHtmlService() {
//        Intent intent=new Intent(this, HtmlDriverService.class);
//        startService(intent);
//    }
//
...
//        drawer.closeDrawers();
//        Utils.showToast(this,"Getting report");
//    }
//
//    @Override
...
//
//
////            Utils.showToast(getApplicationContext(),"Download speed "+obj.optString("download"));
////            Utils.showToast(getApplicationContext(),"Upload speed "+obj.optString("upload"));
//
//        }
//
//    }
//
//    private JSONObject speedtest() {
//        JSONObject  obj=new JSONObject();
//        try {
//            obj.put("download",downloadspeedtest());
//            obj.put("upload",uploadspeedtest());
//
//        } catch (JSONException e) {
//            e.printStackTrace();
//        }
