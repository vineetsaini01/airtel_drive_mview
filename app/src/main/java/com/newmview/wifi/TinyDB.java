...
//    public void putListMasterActivity(String key, ArrayList<MasterActivity> intList) {
//        Integer[] myIntList = intList.toArray(new Integer[intList.size()]);
//        preferences.edit().putString(key, TextUtils.join("‚‗‚", myIntList)).apply();
//    }
    ...
    public void putListObject(String key, ArrayList<CapturedPhoneState.BasicPhoneState> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    ...
    public void putListObject1(String key, ArrayList<String> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
