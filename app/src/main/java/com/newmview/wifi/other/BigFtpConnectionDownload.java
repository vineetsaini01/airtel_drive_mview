...
public class BigFtpConnectionDownload {
...
//        this.finalPath=finalPath;
        ...
        try {
            ...
            sftpChannel.get(src, f, new BigFtpConnectionDownload.SfProgressMonitor(context));
            sftpChannel.exit();
            session.disconnect();
...
//                        Log.i("Linkspeed","3 case");
                    ...
                    try {
                        ...
                        Utils.appendLog("ELOG_BIG_FTP_JSON_INSERT_PANEL: is "+uploadArray);
                        DB_handler db_handler = new DB_handler(MviewApplication.ctx);
                        db_handler.open();
                        String start_date = db_handler.start_date("BigFtp");
                        db_handler.updateEndDate("BigFtp",start_date);
                        db_handler.insertInLoggingAgentTable("BigFtp", "bigftp_report", uploadArray.toString(),date_time, "init");
                        db_handler.close();
...
//                    mView_HealthStatus.mySpeedTest.bigDownloadtest = mView_HealthStatus.mySpeedTest.new UploadDownload();
