/*
package com.mcpsinc.mview.customview;
...
public class HeatMapHelper extends View implements View.OnTouchListener {
...
/**
    ...
    private List<ca.hss.heatmaplib.HeatMap.DataPoint> data;
...
/**
    ...
    private List<ca.hss.heatmaplib.HeatMap.DataPoint> dataBuffer;
...
/**
    ...
    */
/**
     * The minimum opacity to use in the map. Only used when {@link ca.hss.heatmaplib.HeatMap#opacity} is 0.
     *//*

    private int minOpacity = 0;
    */
/**
     * The maximum opacity to use in the map. Only used when {@link ca.hss.heatmaplib.HeatMap#opacity} is 0.
     *//*
...
/**
    ...
    private ca.hss.heatmaplib.HeatMap.OnMapClickListener mListener;
...
/**
    ...
    */
/**
     * Set the minimum opacity to be used in the map. Only used when {@link ca.hss.heatmaplib.HeatMap#opacity} is 0.
    ...
    */
/**
     * Set the maximum opacity to be used in the map. Only used when {@link ca.hss.heatmaplib.HeatMap#opacity} is 0.
...
/**
     ...
     *
     * Does not refresh the display. See {@link ca.hss.heatmaplib.HeatMap#forceRefresh()} in order to redraw the heat map.
     * @param point A new data point.
     *//*

    @AnyThread
    public void addData(ca.hss.heatmaplib.HeatMap.DataPoint point) {
...
/**
    ...
    public void setOnMapClickListener(ca.hss.heatmaplib.HeatMap.OnMapClickListener listener) { this.mListener = listener; }

    */
/**
     * Register a callback to be invoked when this view is touched.
     * @param listener The callback that will run
     * @deprecated Use {@link #setOnMapClickListener(ca.hss.heatmaplib.HeatMap.OnMapClickListener)} instead.
     *//*
...
/**
    ...
    public HeatMapHelper(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize();
...
/**
    ...
    private void drawTransparent(Canvas canvas, int width, int height) {
        ...
        for (ca.hss.heatmaplib.HeatMap.DataPoint point : data) {
        ...
        if (mListener != null) {
            if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
                ...
                if (d < 10) {
                    ...
                    ca.hss.heatmaplib.HeatMap.DataPoint minPoint = null;
                    for (ca.hss.heatmaplib.HeatMap.DataPoint point : data) {
...
/**
    ...
    public interface OnMapClickListener {
        void onMapClicked(int x, int y, ca.hss.heatmaplib.HeatMap.DataPoint closest);
    }
}
*/
