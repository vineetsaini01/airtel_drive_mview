...
public class NetworkFragmentNew2 extends Fragment {
    ...
    TextView  txt_rssival,txt_echoval,txt_snrval ,txt_battery,txt_batteryVal;

    TextView txt_snr,txt_wifiState,txt_wifiStateval;
    TextView txt_lac,txt_dataSim,txt_dataSimVal;

    //labels
    TextView txt_rnc,txt_rssi,txt_psc;
    //RSSI is rxd signal strength indication

    TextView  txt_lonval,txt_latval,txt_airplane,txt_airplaneval ;
    TextView  txt_speedval,txt_gpsaccuracyval ;
    TextView  txt_heightval,txt_altitudeval, txt_groundval ;
     TextView textViewphoneImsi,textView1phoneImsi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v =  inflater.inflate(R.layout.fragment_network_new2, container, false);
    ...
    private void init() {
        ...
        textViewphoneImsi=v.findViewById(R.id.textViewphoneImsi);
        textView1phoneImsi=v.findViewById(R.id.textView1phoneImsi);
        ...
        txt_wifiState=v.findViewById(R.id.txt_wifiState);
        txt_wifiStateval=v.findViewById(R.id.txt_wifiStateval);
        txt_dataSim=v.findViewById(R.id.txt_dataSim);
        txt_dataSimVal=v.findViewById(R.id.txt_dataSimVal);
        txt_airplane=v.findViewById(R.id.txt_airplane);
        txt_airplaneval=v.findViewById(R.id.txt_airplaneval);
        txt_battery=v.findViewById(R.id.txt_battery);
        txt_batteryVal=v.findViewById(R.id.txt_batteryVal);
    ...
    public void updateUI() {
        ...
        if (TextUtils.isEmpty(networkOperator) == false) {
            ...
            // by SWAPNIL 13/03/2023
            textView1phoneImsi.setText(Utils.getImsi(getContext()));
            txt_wifiStateval.setText(Utils.getwifistate(getContext()));
            txt_dataSimVal.setText(mView_HealthStatus.lteRSRQ);
            txt_airplaneval.setText(Utils.isAirplaneModeOn());
            txt_batteryVal.setText(Utils.getBatteryPercentage(getContext()));
        }
        else
        {
        ...
        txt_cqival.setText(mView_HealthStatus.newCQI);
...
//            txt_cellidval.setText(mView_HealthStatus.lteArfcn);
            ...
            if(mView_HealthStatus.lteSNR!=null) {
                System.out.println(" new sinr is"+mView_HealthStatus.newSinr);
                txt_snrval.setText(mView_HealthStatus.newSinr);
            }
            else
            {
                txt_snrval.setText(mView_HealthStatus.newSinr);
