...
public class TraceRouteTableViewAdapter  extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    Context mContext;
    ...
    public TraceRouteTableViewAdapter(Context context) {
        super(context);
        mContext=context;
    ...
    public AbstractViewHolder onCreateCellViewHolder(ViewGroup parent, int viewType) {
        // Get cell xml layout
        View layout = LayoutInflater.from(mContext).inflate(R.layout.my_cell_layout1, parent, false);
    ...
    public AbstractViewHolder onCreateColumnHeaderViewHolder(ViewGroup parent, int viewType) {
        ...
        View layout = LayoutInflater.from(mContext).inflate(R.layout.table_view_column_header_layout1, parent, false);
