...
//
//public class MapLinearListAdapter extends RecyclerView.Adapter<MapLinearListAdapter.MapVh> {
...
//
//public MapLinearListAdapter(Context context, List<MapModel> mapList, Interfaces.EventListener listener) {
//        mContext=context;
...
//        MapListDetailsBinding binding = DataBindingUtil.inflate(
//        LayoutInflater.from(parent.getContext()),
//        R.layout.map_list_details, parent, false);
//
//
...
//    public MapListDetailsBinding binding;
//    public TableLayout mapTable;
//    private CompareHeatMapFragment compareHmFragment;
//
//
//    public MapVh(MapListDetailsBinding binding) {
...
//        {
//            case R.id.actionBtn:
//                boolean showWalkMapButton=false;
//                String walkMapPath=mapList.get(getAdapterPosition()).getMapPath();
//                if(Utils.checkifavailable(walkMapPath))
//                {
//                    showWalkMapButton = true;
//                }
//
//                CommonAlertDialog.showCustomPopup(
//                        v,showWalkMapButton,R.layout.map_action_layout,mContext,
...
//
//                    try {
//                        Log.i(TAG,"Final map path "+finalmapPath +" warning ignored "+warningIgonred);
//                        if(warningIgonred==1)
//                        {
