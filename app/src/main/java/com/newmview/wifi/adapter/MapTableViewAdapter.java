...
public class MapTableViewAdapter  extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    Context mContext;
    ...
    public MapTableViewAdapter(Context context) {
        super(context);
        mContext=context;
    ...
    public void onBindCellViewHolder(@NonNull AbstractViewHolder holder, @Nullable Cell cellItemModel, int columnPosition, int rowPosition) {
     ...
     //   viewHolder.cell_textview.setTextColor(mContext.getResources().getColor(R.color.white));
         if(textColor!=0)
                {
                    viewHolder.cell_textview.setTextColor(mContext.getResources().getColor(R.color.green));
                }
                else
                {
